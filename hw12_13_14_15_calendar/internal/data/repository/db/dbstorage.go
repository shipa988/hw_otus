...
func (repo *EventRepo) GetForPeriod(ctx context.Context, userID string, dateStart time.Time, dateEnd time.Time) ([]*entities.Event, error) {
...
func (repo *EventRepo) DeleteByID(ctx context.Context, userID, eventID string) error {

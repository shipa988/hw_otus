...
import (
	"github.com/shipa988/hw_otus/hw12_13_14_15_calendar/internal/data/controllers/grpcserver"
	"github.com/shipa988/hw_otus/hw12_13_14_15_calendar/internal/data/controllers/httpserver"
...
func InitRepo(cfg *AppConfig, logger usecases.Logger) (entities.EventRepo, error) {
	switch cfg.RepoType {
	case "db":

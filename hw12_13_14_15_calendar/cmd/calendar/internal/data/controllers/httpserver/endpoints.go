...
import (
	...
	api "github.com/shipa988/hw_otus/hw12_13_14_15_calendar/cmd/calendar/api/httpapi"
...
func NewAPIHandler(calendar usecases.Calendar, logger mainusecase.Logger) *APIHandler {
	return &APIHandler{
		calendar: calendar,
		logger:   logger}
}
